...
class IdentityRoute extends PolymerElement {
  static get template() {
    return html`
      ...
      <div class="split">
        <div class="side">
          <div class="sidebar">
            <img src="./images/profile-step2.png" class='steps'>
            <div class='step-text'>
              <div>Profile</div>
        ...
        <div class="main">
          ...
          <div class="input-area">
            ...
            <div class="footer">
              <button type="button" on-click="_saveProfile">Submit Profile & Documents</button>
            </div>
  ...
  ready() {
    super.ready();
    this.kycToken = localStorage.getItem("kyc_token");
...
_save(data){
  ...
  .then(response => {
    this.set('route.path', '/dasboard/identity/')
  })
  .catch(error => console.error('Error:', error));
}

  
} window.customElements.define('identity-route', IdentityRoute);
