      ...
      <div class="split">
        <div class="main">
            <ol>
              ...
              <ol>
                <li>To the maximum extent permitted by applicable law, any litigation or other dispute resolution between You and WORBLI and/or You and another User or interested party arising out of or relating to the Platform Terms, the Platform, or Your relationship with WORBLI will be resolved in accordance with the WORBLI Arbitration Rules. You and WORBLI hereby consent to the personal jurisdiction of the arbitrator (or any substitute or replacement arbitrator, as applicable) appointed pursuant to the WORBLI Arbitration Rules with respect to any such dispute resolution. The seat of arbitration shall be Singapore.</li>
...
} window.customElements.define('platformterms-route', PlatformTermsRoute);
