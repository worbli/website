      ...
      <div class="split">
        <div class="main">
          <div class="team-holder">
              ...
              <worbli-profile name="valentin" title="Software Developer" linkedin="valentin" profile="Profile"></worbli-profile>            
              <worbli-profile name="matt-haynes" title="title" linkedin="matthaynes" profile="Profile"></worbli-profile>            
            </div>
        </div>
        <div class="side">
