          ...
          <h1>Network Terms</h1>
          	<ol>
				...
				<ol>
					...
					<ol>
						<li>the Tokens are intended to function as a means to access and use the Network and the Services;</li>
						<li>Your holding of the Tokens carries no rights, express or implied, other than as a means to access the Services. In particular, You understand and accept that the Tokens do not represent or confer any ownership right or stake, share or security or equivalent rights, or any right to receive future revenue shares, intellectual property rights or any other form of participation in or relating to WORBLI and its corporate affiliates or its property, other than rights relating to the receipt of Services, subject to limitations and conditions in these Network Terms and any Additional Legal Terms;</li>
						<li>the Tokens are not intended to be a security, commodity or any other kind of financial instrument;</li>
						<li>You have a sufficient understanding of the functionality, usage, storage, transmission mechanisms and other material characteristics of cryptographic tokens, token storage mechanisms, blockchain technology and blockchain-based software systems to understand the Network and to appreciate the risks and implications of purchasing the Tokens;</li>
						<li>You have obtained sufficient information about the Tokens to make informed decisions in respect of the Tokens;</li>
						<li>You understand that the Tokens confer only the right to access the Services, and confer no other rights of any form with respect to WORBLI or its corporate affiliates or property, including, but not limited to, any voting, distribution, redemption, liquidation, proprietary (including all forms of intellectual property), or other financial or legal rights;</li>
						<li>Our provision of the Tokens to You is solely for the purpose of You accessing the Services and not for any other purposes, including, but not limited to, any investment, speculative or other financial purposes;</li>
						<li>Your receipt, holding and/or use of the Tokens complies with applicable law and regulation in your jurisdiction, including, but not limited to, (i) legal capacity and any other applicable legal requirements in your jurisdiction for the Tokens, using the Tokens, and entering into contracts with us, (ii) any foreign exchange or regulatory restrictions applicable to such purchase, and (iii) any governmental or other consents that may need to be obtained;</li>
						<li>You are not, nor are you an agent of, (i) a citizen or resident of a country or territory in which access to or use of the Tokens or the Network is prohibited by applicable law, decree, regulation, treaty, or administrative act, (ii) a citizen or resident of, or located in, a country or territory that is subject to sanctions or embargoes imposed by the United States or any other country, or (iii) an individual or entity, nor an individual or entity employed by, acting on behalf of, or affiliated with an entity, identified on the U.S. Department of Commerce's Denied Persons or Entity List, the U.S. Department of Treasury's Specially Designated Nationals and Blocked Persons Lists, or the U.S. Department of State's Debarred Parties List (collectively, "Restricted Party Lists"). You further agree that you will not use the Tokens or Services in connection with transactions (i) in any country or territory that is subject to U.S. or other sanctions or embargoes, (ii) with any individual or entity that is identified on the Restricted Party Lists, nor (iii) otherwise prohibited by U.S. sanctions and export control laws and regulations including the sanctions regulations administered by the U.S. Department of the Treasury Office of Foreign Assets Control, 31 C.F.R. §§ 500-599, and the Export Administration Regulations, 15 C.F.R. §§ 730-774. You agree that if your country of residence or any other circumstances change such that the above representations are no longer accurate, then you will immediately cease using the Services and notify WORBLI. If you are registering to use the Services on behalf of a legal entity, you further represent and warrant that (i) such legal entity is duly organized and validly existing under the applicable laws of the jurisdiction of its organization, and (ii) you are duly authorized by such legal entity to act on its behalf; and</li>
...
} window.customElements.define('networkterms-route', NetworkTermsRoute);
