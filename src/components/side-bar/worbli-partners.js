  ...
  static get template() {
    return html`
      <style include="shared-styles">
       ...
       .bps a:nth-child(5) div {background: url('./images/strategic-partners.png') -1267px -71px;}
       .bps a:nth-child(6) div {background: url('./images/strategic-partners.png') -889px -60px;  background-size: 1225% auto;}
       .bps a:nth-child(7) div {background: url('./images/strategic-partners.png') -485px -70px; margin-right:12px; margin-bottom:0px;}
       .bps a:nth-child(8) div {background: url('./images/strategic-partners.png') -92px -71px; margin-bottom:0px;}
      </style>
